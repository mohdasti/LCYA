ggplot_objects_VDT <- list(
  plot1 = ggplot(combined_VDT_4T, aes(x = stimLev, y = prop, group = condition, color = condition)) +
    geom_point(size = 2) +
    geom_line(size = 1.2) +
  ...
  plot2 = ggplot(combined_grip_VDT_4T, aes(x = stimLev, y = prop, group = condition, color = condition)) +
    geom_point( size = 2) +
    geom_line(size = 1.2) +
  ...
  plot3 = ggplot(combined_medRT_VDT_4T, aes(x = stimLev, group = condition, color = condition, linetype= condition)) +
  ...
  plot4 = ggplot(combined_RT_VDT_4T, aes(x = stimLev, group = condition, color = condition, linetype= condition)) +
    geom_point(aes(y = ifelse(condition == "Different", medRT_diff , medRT_same)), size = 2) +
    geom_line(aes(y = ifelse(condition == "Different", medRT_diff, medRT_same)), size = 1.2) +
  ...
  plot5 = ggplot(data = combined_medRT_grip_VDT_4T) +
  ...
  plot6 = ggplot(data = combined_RT_grip_VDT_4T) +
    geom_point(aes(x = stimLev, y = medRT_high_diff, color = condition), size = 2) +
    geom_line(aes(x = stimLev, y = medRT_high_diff, color = condition, group = condition), size = 1.2) +
    geom_linerange(aes(x = stimLev, ymin = medRT_high_diff - medRT_high_diff_se, 
                       ymax = medRT_high_diff + medRT_high_diff_se, color = condition), 
  ...
  plot7 = ggplot(combined_prop_VDT_4T, aes(x = stimLev, group = condition, color = condition)) +
  ...
  plot8 = ggplot(combined_conf_grip_VDT_4T, aes(x = stimLev, color = condition)) +
