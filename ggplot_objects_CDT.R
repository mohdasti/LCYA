ggplot_objects_CDT <- list(
  
  plot1 = ggplot(combined_CDT_4T, aes(x = stimLev, y = prop, group = condition, color = condition)) +
    geom_point(size = 2) +
    geom_line(size = 1.2) +
  ...
  plot2 = ggplot(combined_grip_CDT_4T, aes(x = stimLev, y = prop, group = condition, color = condition)) +
    geom_point( size = 2) +
    geom_line(size = 1.2) +
  ...
  plot3 = ggplot(combined_medRT_CDT_4T, aes(x = stimLev, group = condition, color = condition, linetype= condition)) +
  ...
  plot4 = ggplot(combined_RT_CDT_4T, aes(x = stimLev, group = condition, color = condition, linetype= condition)) +
    geom_point(aes(y = ifelse(condition == "Different", medRT_diff , medRT_same)), size = 2) +
    geom_line(aes(y = ifelse(condition == "Different", medRT_diff, medRT_same)), size = 1.2) +
  ...
  plot5 = ggplot(data = combined_medRT_grip_CDT_4T) +
  ...
  plot6 = ggplot(data = combined_RT_grip_CDT_4T) +
    geom_point(aes(x = stimLev, y = medRT_high_diff, color = condition), size = 2) +
    geom_line(aes(x = stimLev, y = medRT_high_diff, color = condition, group = condition), size = 1.2) +
    geom_linerange(aes(x = stimLev, ymin = medRT_high_diff - medRT_high_diff_se, 
                       ymax = medRT_high_diff + medRT_high_diff_se, color = condition), 
    ...
    ggtitle("Median of Within and Mean Between Reaction Time - CDT") +
    xlab("Degree") +
    ylab("Median Reaction Time") +
    labs(caption = "Error bars represent within-subject SEM") +
    scale_color_manual(values = c("#BC3C29FF", "#ea9999", "#0072B5FF", "#CCE6FF"),
  ...
  plot7 = ggplot(combined_prop_CDT_4T, aes(x = stimLev, group = condition, color = condition)) +
  ...
  plot8 = ggplot(combined_conf_grip_CDT_4T, aes(x = stimLev, color = condition)) +
